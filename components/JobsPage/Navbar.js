						...
						<ul className="menu menu-horizontal px-4 font-bold">
							<li tabIndex={0}>
								...
								<ul className="p-2 text-neutral bg-neutral-content z-10">
									...
									<li>
										<Link href="/jobs/electrician">
											Electrician
										</Link>
									</li>
									<li>
										<Link href="/jobs/plumber">
											Plumber
										</Link>
									</li>
									<li>
										<Link href="/jobs/mechanic">
											Mechanic
										</Link>
									</li>
									<li>
										<Link href="/jobs/cook">Cook</Link>
									</li>
									<li>
										<Link href="/jobs/peon">Peon</Link>
									</li>
									<li>
										<Link href="/jobs/driver">Driver</Link>
									</li>
									<li>
										<Link href="/jobs/housekeeping">
											House Keeping
										</Link>
									</li>
									<li>
										<Link href="/jobs/securityguard">
											Security Guard
										</Link>
									</li>
									<li>
										<Link href="/jobs/siteworkers">
											Site Worker
										</Link>
									</li>
								</ul>
